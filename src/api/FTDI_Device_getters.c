...
napi_value device_get_modem_status(napi_env env, napi_callback_info info) {
  ...
  // Get info from FTDI
  ULONG status;
  utils_check(FT_GetModemStatus(instance_data->ftHandle, &status));
  ...
  napi_value object;
  const napi_property_descriptor props[] = {
    { "clear_to_send", NULL, NULL, NULL, NULL, status & 0x10 ? bool_true : bool_false, napi_enumerable, NULL },
    { "data_set_ready", NULL, NULL, NULL, NULL, status & 0x20 ? bool_true : bool_false, napi_enumerable, NULL },
    { "ring_indicator", NULL, NULL, NULL, NULL, status & 0x40 ? bool_true : bool_false, napi_enumerable, NULL },
    { "data_carrier_detect", NULL, NULL, NULL, NULL, status & 0x80 ? bool_true : bool_false, napi_enumerable, NULL },
    { "overrun_error", NULL, NULL, NULL, NULL, status & 0x0200 ? bool_true : bool_false, napi_enumerable, NULL },
    { "parity_error", NULL, NULL, NULL, NULL, status & 0x0400 ? bool_true : bool_false, napi_enumerable, NULL },
    { "framing_error", NULL, NULL, NULL, NULL, status & 0x0800 ? bool_true : bool_false, napi_enumerable, NULL },
    { "break_interrupt", NULL, NULL, NULL, NULL, status & 0x1000 ? bool_true : bool_false, napi_enumerable, NULL },
  };
  size_t nb_props = sizeof(props) / sizeof(napi_property_descriptor);
  utils_check(napi_create_object(env, &object));
  utils_check(napi_define_properties(env, object, nb_props, props));
